...
#define E2_STEP_PIN 40   // sigma: 29-->40
#define E2_DIR_PIN 40    // sigma: 28-->40
#define E2_ENABLE_PIN 40 // sigma: 39-->40

#define E3_STEP_PIN 40   // sigma
#define E3_DIR_PIN 40    // sigma
#define E3_ENABLE_PIN 40 // sigma

#define E4_STEP_PIN 29   // sigma: connected to E02 stepper pins
#define E4_DIR_PIN 28    // sigma: connected to E02 stepper pins
#define E4_ENABLE_PIN 39 // sigma: connected to E02 stepper pins
...
#else
#define TEMP_3_PIN 12 // Analog Input (default connector for thermistor *T2* on rumba board is used)
#endif
...
#define HEATER_BED_PIN 30 // disabled

#define FAN_PIN 2
#define FAN1_PIN 3
#define FAN2_PIN 6 // sigma
